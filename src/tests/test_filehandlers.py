...
class TestFileHandlers(unittest.TestCase):
    ...
    def test_read_csv(self):
        ...
        """
        self.city_1: str = self.test_list[0]["city_ascii"]
        self.country_1: str = self.test_list[0]["country"]
        self.state_1: str = self.test_list[0]["admin_name"]
        self.city_2: str = self.test_list[3]["city_ascii"]
        self.country_2: str = self.test_list[3]["country"]
        self.state_2: str = self.test_list[3]["admin_name"]
    ...
    def test_save_csv_as_json(self):
        ...
        """
        self.city_3: str = self.text_from_json[1]["city_ascii"]
        self.country_3: str = self.text_from_json[1]["country"]
        self.state_3: str = self.text_from_json[1]["admin_name"]
        self.city_4: str = self.text_from_json[4]["city_ascii"]
        self.country_4: str = self.text_from_json[4]["country"]
        self.state_4: str = self.text_from_json[4]["admin_name"]
